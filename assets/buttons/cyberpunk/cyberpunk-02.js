export default {
    ...
    name: "Button 33",
    html: `<button class="btn-33">Button 33 <span class="glitch"></span></button>`,
    css: `.btn-33 {
    width: 120px;
    height: 40px;
    position: relative;
...
.btn-33:hover .glitch {
    opacity: 1;
    animation: glitchMove 0.25s steps(2) forwards;
}
...
.btn-33:hover {
    ...
    js: `document.querySelectorAll('.btn-33').forEach(function(btn){
